...
SMTP_PORT = 587
SENDER_EMAIL = "chinnuprashanth868@gmail.com"
SENDER_PASSWORD = "qwqn gubc pseq ipiw"
...
def escalate_ticket_with_email(issue: str) -> dict:
    ...
    success = send_email(to_email="algottuprashanth@gmail.com", subject=subject, body=body)
